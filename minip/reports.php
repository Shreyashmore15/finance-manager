...
$res=mysqli_query($db,"select sum(expense.price) as price,category.name from expense,category where expense.category_id=category.id $sub_sql group by expense.category_id");
?>
<script>
...
<div class="y_form">
 <form type="get">
	 ...
	 <input type="submit" name="submit" value="Submit" class="btn btn-lg btn-info btn-block w0">
